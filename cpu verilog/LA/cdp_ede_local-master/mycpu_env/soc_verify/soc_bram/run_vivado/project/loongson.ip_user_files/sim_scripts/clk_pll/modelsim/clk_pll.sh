...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/LA/LAEND_zd/LAEND/LAEND/LA/LA/cdp_ede_local-master/mycpu_env/soc_verify/soc_bram/run_vivado/project/loongson.cache/compile_simlib/modelsim"
  fi
